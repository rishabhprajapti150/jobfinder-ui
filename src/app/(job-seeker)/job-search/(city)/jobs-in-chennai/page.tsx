...
import specificJobDetails, { chennaiJobs } from "@/utils/mock-json";
  ...
  return (
    <>
      ...
      <JobSeachByLocationComponent
        jobs={chennaiJobs as unknown as IJobSearchLists[]}
        specificJobDetails={chennaiJobs as unknown as IJobSearchLists[]}
