...
import specificJobDetails, { mumbaiJobs } from "@/utils/mock-json";
  ...
  return (
    <>
      ...
      <JobSeachByLocationComponent
        jobs={mumbaiJobs as unknown as IJobSearchLists[]}
        specificJobDetails={mumbaiJobs as unknown as IJobSearchLists[]}
