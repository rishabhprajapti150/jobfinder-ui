      ...
      <div className="w-full max-w-md rounded-xl bg-white p-6 shadow-lg dark:bg-gray-800">
        <div className="flex flex-col items-center space-y-4 text-center">
          ...
          <div className="flex w-full space-x-3 pt-4">
            <button
              onClick={handleReset}
              className="flex-1 rounded-lg bg-blue-600 px-4 py-2 text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:bg-blue-500 dark:hover:bg-blue-600"
            >
              <ArrowPathIcon className="mr-2 inline" />
              Try Again
            </button>
            
            <button
              onClick={() => router.push('/')}
              className="flex-1 rounded-lg border border-gray-300 px-4 py-2 text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-700"
            >
              <HomeIcon className="mr-2 inline" />
              Go Home
            </button>
          </div>
        </div>
