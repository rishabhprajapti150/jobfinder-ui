            ...
            <div className="relative">
                ...
                <div className="absolute inset-y-52 inset-x-4  m-4">
                    ...
                    <div className="flex gap-5 py-4">
                        <LinkButton type="button" className="searchBtn py-3 px-9 bg-[#145af3] text-white hover:bg-[#2278f9] hover:transition-all hover:duration-200">Search Job</LinkButton>
                        <LinkButton type="button" className="searchBtn py-3 px-9 bg-[#145af3] text-white hover:bg-[#2278f9] hover:transition-all hover:duration-200">Find A Talent </LinkButton>
                    </div>
